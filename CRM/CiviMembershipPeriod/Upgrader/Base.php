 ...
 */
class CRM_CiviMembershipPeriod_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_CiviMembershipPeriod_Upgrader(
        'org.civicrm.module.civimembershipperiod',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_CiviMembershipPeriod_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
